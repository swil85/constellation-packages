...
namespace Tuya
{
    ...
    public class TuyaPlug : TuyaDevice
    {
        ...
        public async Task<TuyaStatus> GetStatus()
        {
            ...
            var buffer = ConstructBuffer(payload, (int)TuyaDevice.Command.GetStatus);
        ...
        /// <param name="delay">delay before set</param>
        public async Task SetStatus(bool status, int delay = 0)
        {
            ...
            var buffer = ConstructBuffer(payload, (int)TuyaDevice.Command.SetStatus);
